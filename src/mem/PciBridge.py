...
import os 
home = os.getenv('HOME')
sys.path.append(str(home) + '/t_gem5/gem5/src/mem')
...
###Bridge related params
    ...
    master1 = MasterPort('Master port')
    master2 = MasterPort('Master port') 
    master3 = MasterPort('Master Port')

    slave_dma1 = SlavePort('Slave port')
    master_dma = MasterPort('Master port')
    slave_dma2 = SlavePort('Slave port') 
    slave_dma3 = SlavePort('Slave Port ') 
